...
::ZQ05rAF9IAHYFVzEqQIdCyhnYAWXMmiyA6co5+f3r+yIsA1MGrpxLs/o36aYJfIAig==
::eg0/rx1wNQPfEVWB+kM9LVsJDCmhD1iWB6AS6+D+/d6IrUFdUu0tON6VgvrYYNMW+FPhZ4VN
::fBEirQZwNQPfEVWB+kM9LVsJDCmhD1iWB6AS6+D+/d6IrUFdUu0tON6VgvrYYNMW+FPhZ4VN
::cRolqwZ3JBvQF1fEqQIdCyhnYAWXMmiyA6co5+f3r+yIsA1MGrpxLs/o36aYJfIAig==
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFBVdRw+NAE+/Fb4I5/jHw+uSrE4VUfADYNmP5piPLvoS7kr2NZIolklfit0FCBRKewHrP0Fs5zgCrjLRecKEtm8=
::YB416Ek+ZW8=
::
::
...
echo(
echo Necesitas tener a lo menos [Java 8](https://www.java.com/es/download/ie_manual.jsp) para poder iniciar un servidor hasta la Versión 1.16.5. A partir de la Versión 1.8.6, es necesrio contar con [JDK 16](https://www.oracle.com/java/technologies/javase-jdk16-downloads.html).
echo(
