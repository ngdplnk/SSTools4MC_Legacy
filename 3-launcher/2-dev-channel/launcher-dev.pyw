...
try:
    code = requests.get("https://raw.githubusercontent.com/ngdplnk/SSTools4MC/main/2-dev/dev.py") # Program permalink
    ...
    if os.path.exists(ICON_PATH):
        ...
        icon = requests.get("https://raw.githubusercontent.com/ngdplnk/SSTools4MC/main/3-launcher/2-dev-channel/icon-dev.ico") # Icon permalink
