...
try:
    ...
    LOGGER.info(f'SSVERSION: {SSVERSION}')
    LOGGER.info(f'YEAR: {YEAR}')
    LOGGER.info(f'CHANGELOG_ENG: {CHANGELOG_ENG}')
    LOGGER.info(f'CHANGELOG_SPA: {CHANGELOG_SPA}')
    LOGGER.info(f'NEEDED_MODULES: {NEEDED_MODULES}')
