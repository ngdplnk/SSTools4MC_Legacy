...
#################################
####      PROGRAM INFO       ####
SSVERSION = 'v24.11.20-dev'
CHANNEL = 'dev'
YEAR = '2024'
CHANGELOG_ENG = '- Added support for new versions'
CHANGELOG_SPA = '- Soporte añadido para nuevas versiones'
...
#################################
### THINGS TO DO/FIX - UPDATED: 04/10/2024 ###
...
#################################
### DEVELOPER NOTES ###
# - Logging system needs to be improved. This is still in the works so consider adding some log messages when updating the program.
# - Working on Portuguese translation. This wouldn't be accessible until it's fully translated.
#################################
...
try:
    ### IMPORT MINECRAFT VERSIONS ###
    with open('versions.fetch', 'r') as file:
        data = json.load(file)
        MC_STABLE = data.get('MC_STABLE', {})
        MC_SNAPSHOT = data.get('MC_SNAPSHOT', {})
    LOGGER.info("Versions fetched from file")
