...
title Actualizador de Servidores por NGDPLNk

:init
cls
echo Actualizador de Servidores de Minecraft
echo MCSSTools Release v0.0.1.2 por NGDPL Nk
echo --------------------------------------
echo(
echo Estas en el Menu Principal
echo(
echo (I) Actualizar un Servidor
...
set /P c=Escribe la Version de Minecraft para Actualizar tu Servidor= 
...
echo(
echo Puedes volver al Menu Principal con "N", o
set /P c=Reescribe la Version de Minecraft para Actualizar tu Servidor= 
if /I "%c%" EQU "N" goto :init
if /I "%c%" EQU "1.2.1" goto :1.2.1
if /I "%c%" EQU "1.2.2" goto :1.2.2
if /I "%c%" EQU "1.2.3" goto :1.2.3
...
echo --------------------------------------
echo(
echo Lista de Versiones de Minecraft Disponibles para Actualizar
echo(
echo - 1.2.1
echo - 1.2.2
echo - 1.2.3
