...
::ZQ05rAF9IAHYFVzEqQIdCyhnYAWXMmiyA6co5+f3r+yIsA1MGrNqNt2b6bGcNuUB+SU=
::eg0/rx1wNQPfEVWB+kM9LVsJDCmhD1iWB6AS6+D+/d6IrUFdUu0tON6Vi+HAcqAg71fycIQ+tg==
::fBEirQZwNQPfEVWB+kM9LVsJDCmhD1iWB6AS6+D+/d6IrUFdUu0tON6Vi+HAcqAg71fycIQ+tg==
::cRolqwZ3JBvQF1fEqQIdCyhnYAWXMmiyA6co5+f3r+yIsA1MGrNqNt2b6bGcNuUB+SU=
...
echo(
echo Necesitas tener a lo menos [Java 8](https://www.java.com/es/download/ie_manual.jsp) para poder iniciar un servidor hasta la Versión 1.16.5. A partir de la Versión 1.15.2, es necesrio contar con [JDK 16](https://www.oracle.com/java/technologies/javase-jdk16-downloads.html).
echo(
