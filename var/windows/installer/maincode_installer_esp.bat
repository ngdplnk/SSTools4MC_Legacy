...
if /I "%version%" EQU "1.19.4" set version=1.19.4& set link=https://piston-data.mojang.com/v1/objects/8f3112a1049751cc472ec13e397eade5336ca7ae/server.jar& goto :install
...
if /I "%vslista%" EQU "3" goto :version
goto :vslist
